...
module processingCore #(
    ...
    euc_dist_0 EucDist (
      ...
      .ap_start(euc_start && ~euc_done),                //input wire ap_start. No tiene problemas con empezar 2 veces pero igual por consistencia
    ...
    dot_prod_0 DotProd (
      ...
      .ap_idle(),                                       // output wire ap_idle
      .ap_ready(),                                      // output wire ap_ready
      .ap_start(dot_start && ~dot_done),                // input wire ap_start. Incluye condición para evitar reiniciar la operación antes de que termine (parche para el delay)
