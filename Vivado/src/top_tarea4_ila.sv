`timescale 1ns / 1ps
// Versión con ila para medir la latencia de las operaciones

module top_tarea4_ila #(
...
//        //.LED_cmd_decoder  (LED[5:2]),
    ...
    ila_0 ILA (
    	...
    	.probe0(euc_start),     // input wire [0:0]  probe0  
    	.probe1(dot_start),     // input wire [0:0]  probe1
    	.probe2(op_done_src)    // input wire [0:0]  probe2
    );
